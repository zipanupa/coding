...
$nodes = @(
,[PSCustomObject]@{Name = "Lon CL"; Host = "10.44.63.1"}
,[PSCustomObject]@{Name = "Lon Vz"; Host = "10.44.63.17"}
,[PSCustomObject]@{Name = "DC1 CL"; Host = "10.101.15.1"}
,[PSCustomObject]@{Name = "DC1 Vz"; Host = "10.101.15.17"}
,[PSCustomObject]@{Name = "Par CL"; Host = "10.33.31.1"}
