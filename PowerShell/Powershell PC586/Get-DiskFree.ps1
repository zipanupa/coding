...
Get-DiskFree wfwdc1exch01,wfwdc1exch02,wfwdc1exch03,wfwdc1exch04,wfwdc2exch01,wfwdc2exch02,wfwdc2exch03,wfwdc3exch01,wfwdc3exch02 -Format | select name, vol, size, avail | ft -autosize